...
namespace FreeCourse.Services.Discount.Services
{
        ...
        : IDiscountService
    {
        ...
        {
            var hasDiscount = (await _dbConnection.QueryAsync<Models.Discount>("select * from discount where userid=@UserId and code=@Code", new { UserId = userId, Code = code })).FirstOrDefault();
            if (hasDiscount == null)
            {
